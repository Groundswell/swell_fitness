...
require 'kaminari'
require 'pundit'
require 'swell_fitness/controllers/application_controller_extensions'
require 'fb_graph'
require 'staccato'
...
module SwellFitness
	...
	class << self
		...
		self.registered_media_types = [ 'SwellFitness::Article', 'SwellFitness::Page' ]
	...
	class Engine < ::Rails::Engine
		...
		initializer "swell_fitness.load_helpers" do |app|
			ActionController::Base.send :include, SwellFitness::ApplicationControllerExtensions
		end
