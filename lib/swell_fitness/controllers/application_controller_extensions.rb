...
module SwellFitness
	module ApplicationControllerExtensions
		...
		def init_page_meta
			@page_meta = {
				:title => SwellFitness.app_name,
				:description => SwellFitness.app_description,
				:image => SwellFitness.app_logo,
				:site_name=> SwellFitness.app_name,
				:fb_type => 'article', # blog, website,
				:url => request.url,
				:twitter_format => 'summary',
				:twitter_site => SwellFitness.twitter_handle,
				:og => {},
				:twitter => {},
			}
		end
